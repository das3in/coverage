...
ActiveRecord::Schema.define(version: 2019_05_02_123544) do
  ...
  create_table "matches", force: :cascade do |t|
    ...
    t.index ["tournament_set_id"], name: "index_matches_on_tournament_set_id"
  ...
  add_foreign_key "matches", "tournament_sets"
